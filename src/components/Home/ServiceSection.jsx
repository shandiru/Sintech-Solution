...
const services = [
  {
    ...
    desc: "Comprehensive engine diagnostics to identify and resolve issues quickly and efficiently.",
    image: "/mot.avif", // replace with your actual image
    path: "/services/mot",
  },
  {
    title: "ECU Remapping",
    desc: "Professional ECU remapping to optimize engine performance and enhance fuel efficiency.",
    image: "/dpf-cleaning.avif", // replace with your actual image
    path: "/services/dpf-cleaning",
  },
  {
    title: "Immobilisers",
    desc: "High-quality immobiliser installation and security solutions to protect your vehicle.",
    image: "/carbon-cleaning.avif", // replace with your actual image
              ...
              >
                ...
                <div className="max-w-sm mx-auto">
                  <img
                    src={service.image}
                    alt={service.title}
                    className="absolute inset-0 w-[75%] mt-15 mx-auto h-30 "
                    onError={(e) => {
